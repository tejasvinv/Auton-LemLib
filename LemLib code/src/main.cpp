...
pros::Motor front_intake(10, pros::MotorGearset::blue);        // Blue motor, port 10, normal
pros::Motor mid_intake(1, pros::MotorGearset::green);          // Green motor, port 1, reversed
pros::Motor top_intake(-9, pros::MotorGearset::green);          // Green motor, port 9, reversed
